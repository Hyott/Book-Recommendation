...
# from app.database.crud import get_book_by_isbn, get_sentence_by_isbn, add_user_response, get_tags_by_isbn
# from app.database.schemas import BookSchema, SentenceSchema, UserResponseSchema
# from fastapi.middleware.cors import CORSMiddleware
# import numpy as np
# from sklearn.cluster import KMeans
# from sklearn.metrics.pairwise import cosine_similarity
# from app.services.book_rec_module import load_book_data, load_embeddings, select_books, \
...
# def first_setting_of_logic(user_id, num_clusters, embedding_save_path, llm_output_path):
...
#     ids, book_embeddings, book_data, user_id, question_number, cluster_to_books = first_setting_of_logic(user_id, num_clusters, embedding_save_path, llm_output_path)
